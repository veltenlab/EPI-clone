...
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/young_clonal_umap.png', height = 60, width=50, unit='mm')
```
...
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/clone_sizes_young.pdf', height = 30, width=40, unit='mm')
```
...
to_plot <- to_plot[order(to_plot$Clone, na.last = FALSE), ]
ggplot(to_plot, aes(x=CLONEUMAP_1 , y=CLONEUMAP_2, color=Clone))+geom_point(size=.25)+NoAxes()+NoLegend()+plot_theme+scale_color_manual(values=cols, na.value = 'gray75')+theme(panel.background = element_blank())
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/old_clonal_umap.png', height = 60, width=50, unit='mm')
```
...
ggplot(to_plot, aes(x='', y=RelFreq, fill=x))+geom_histogram(stat='identity', position = 'stack', width=1) +
  coord_polar("y", start=0)+plot_theme+ylab('Frequency')+scale_fill_manual(values=cols, na.value='gray75')+ylab('')+xlab('')+theme(axis.text.x=element_blank(), panel.background = element_blank())
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/clone_sizes_old.pdf', height = 30, width=40, unit='mm')
```
...
ggplot(to_plot, aes(x=Sample, y=RelFreq, fill=x))+geom_histogram(stat='identity')+plot_theme+scale_fill_manual(values=cols, na.value = 'gray75')+facet_wrap(Replicate~., nrow=1)
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/compare_clone_sizes.pdf', height = 65, width=40, unit='mm')
...
to_plot$Replicate <- 'Replicate1'
rep2 <- read.csv('../infos/compare_cluster_sizes_largest.csv', row.names=1)
rep2$Replicate <- 'Replicate2'
to_plot <- rbind(to_plot, rep2)
...
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/compare_cluster_sizes_largest.pdf', height = 20, width=100, unit='mm')
```
...
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/immature_proportion_per_clone.pdf', height = 20, width=100, unit='mm')
```
...
ggsave('/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/aging/myeloid_percentage_young_old.pdf', height = 20, width=100, unit='mm')
```
