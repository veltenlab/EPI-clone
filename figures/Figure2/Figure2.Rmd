...
write.csv(data.frame(subset(larry,use)@reductions$umap@cell.embeddings, LARRY=subset(larry,use)$LARRY), '/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/revision/figures/Figure2/source_data/Fig2B.csv')
...
write.csv(data.frame(subset(larry,use)@reductions$umap@cell.embeddings, LARRY=subset(larry,use)$CellType), '/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/revision/figures/Figure2/source_data/Fig2C.csv')
...
write.csv(data.frame(subset(larry,use)@reductions$umap@cell.embeddings, LARRY=subset(larry,use)$selected), '/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/revision/figures/Figure2/source_data/Fig2D.csv')
```
...
write.csv(data.frame(x=perf@x.values, y=perf@y.values), '/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/revision/figures/Figure2/source_data/Fig2E.csv')
...
write.csv(forriver_norm[,order(maxis)], '/home/mscherer/cluster/project/Methylome/analysis/HSCs/paper/revision/figures/Figure2/source_data/Fig2F.csv')
