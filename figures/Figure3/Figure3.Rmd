...
This vignette describes how to generate the plots for Figure 3 of the EPI-Clone manuscript. We show how EPI-clone can cluster cells by clona identity without requiring genetic barcoding (such as LARRY).

![Figure 1: Experimental design for EPi-Clone. A shows how LARRY barcodes were introduced into HSCs and transplanted into four recipient mice analyzed here. B gives an overview of EPI-Clone.](exp_overview_Fig3.png)
