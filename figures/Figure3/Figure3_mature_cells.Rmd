...
![Figure 1: Experimental design for EPi-Clone. A shows how LARRY barcodes were introduced into HSCs and transplanted into four recipient mice analyzed here. B gives an overview of EPI-Clone.](exp_overview_Fig3_mature.png)
...
static_cpgs <- read.csv('../../infos/cpg_selection.csv',
                  row.names = 1)
static_cpgs <- row.names(static_cpgs[static_cpgs$Type=='Static', ])
